         ...
         <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-right">
                                <div class="actions">
                                    <a href="<?php echo base_url('backend/module/download_module')?>" class="btn btn-success m-b-5 m-r-2"><i class="ti-download"> </i> <?php echo display('download')?></a>
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart("backend/module/upload") ?>
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-2 themeupload">
                        ...
                        <?php echo form_close() ?>
                            ...
                            <div class="row">
                                <?php if(!empty($live_modules)){
                                 ...
                                 ?>
                                 <div class="col-md-4 addonsbox mb-4 card-header">
                                    <div class="thumbnail">
                                        <div class="addon_img">
                                ...
                                foreach ($map as $key => $value) {
                                    ...
                                    if ($value != "index.html" && !in_array($mod, $def_mods)) {
                                        ...
                                        <div class="col-md-4 addonsbox">
                                            <?php 
                                                //form to module 
                                                echo form_open('backend/module/install');
                                            ...
                                            <div class="thumbnail">
                                                <div class="addon_img">
                                              <img src="<?php echo base_url('app/Modules/'.$mod.'/Assets/Images/thumbnail.jpg?v=1') ?>" alt="" class="mod_thumb_img">
                                            </div>
                                              <div class="caption">
                                                ...
                                                <p>
                                                    <?php 
                                                        ...
                                                        if ($rows->countAllResults() > 0 ) { 

                                                    ?>

                                                    <a onclick="return confirm('Are You Sure?')"  href="<?php echo base_url("backend/module/uninstall/$delMod") ?>" class="btn btn-danger"><?php echo display("uninstall") ?></a> 

                                                    <a  href="<?php echo base_url("backend/module/uninstall/$delMod/delete") ?>" type="submit" class="btn btn-danger delete_item"><?php echo display("delete") ?></a>
                                                    ...
                                                    <?php } else {
                                                        ...
                                                        <button onclick="return confirm('Are You Sure?')" type="submit" class="btn btn-success" role="button"><?php echo display("install") ?></button>  
                                                    <?php } } ?>
                                                </p>
                                              </div>
                                            </div>
                                        ...
                                        <div class="col-md-4  addonsbox mb-4">
                                            <div class="thumbnail">
                                                ...
                                                <p><a  href="<?php echo base_url("backend/module/uninstall/$delMod/delete") ?>" type="submit" class="btn btn-danger delete_item"><?php echo display("delete") ?></a></p>
                                              </div>
                                            </div>
                                        <?php
...
<script src="<?php echo base_url().'/app/Modules/Addon/Assets/ajaxs/addons/module.js?v=1.6' ?>"></script>
