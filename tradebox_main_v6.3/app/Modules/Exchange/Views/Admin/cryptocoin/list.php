            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        <div class="actions">
                           <a class="btn btn-success w-md m-b-5 pull-right" href="<?php echo base_url("backend/exchange/cryptocoin-add") ?>"><i class="fa fa-plus" aria-hidden="true"></i> Coin</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table id="ajaxcointable" class="table table-bordered table-hover">
                        <thead>
                            <tr> 
                                ...
                                <th><?php echo display('creator_address');?></th>
