    ...
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card mb-4">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="text-right">
                            <div class="actions">
                               <a href="<?php echo base_url('backend/module/add_module')?>" class="btn btn-success"><i class="ti-align-justify"> </i> <?php echo display('module')?></a> 
                ...
                <div class="card-body">
                    <?php echo form_open('#', array('id' => 'purchase'),array('name'=>'purchase')); ?>
                    ...
                    <div class="col-md-12 col-md-offset-2">
                        ...
                        <div class="form-group">
                            <a href="<?php echo base_url('backend/module/add_module'); ?>" class="btn btn-danger" data-dismiss="modal">Cancel</a>
