                        ...
                        <tbody id="useropenTrade">
                            <?php  foreach ($open_trade as $key => $value) { ?>
                            	<tr>
                                    ...
                                    <td><a href="<?php echo base_url("order-cancel/$value->id") ?>" class="bg-danger text-white text-center pt-1 pb-1 pl-1 pr-1 mb-1 mt-2"  data-toggle="tooltip" data-placement="left" title="Cancel"><?php echo display('cancel') ?></a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
