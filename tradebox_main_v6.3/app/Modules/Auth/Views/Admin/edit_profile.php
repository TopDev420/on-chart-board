<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="card">
            <div class="card-body">
                <?php echo form_open_multipart("backend/edit-profile") ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <img src="<?php echo $user->image?IMAGEPATH.$user->image: BASEPATH."assets/images/icons/user.png" ?>" class="img-thumbnail" width="125" height="100">
                        </div>
