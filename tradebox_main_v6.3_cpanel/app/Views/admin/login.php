...
<?php } ?>
                    ...
                    <div class="card-body">
                        <?php echo form_open('auth/login','id="loginForm" novalidate'); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  placeholder="<?php echo display('captcha') ?>" name="captcha" id="captcha" class="form-control"  value="<?php  echo (!empty($user->captcha)?$user->captcha:null) ?>"> 
                            </div> 
