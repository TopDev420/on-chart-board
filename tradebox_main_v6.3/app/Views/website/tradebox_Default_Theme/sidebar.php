    ...
    <div class="widget">
        ...
        ?>
            <div class="post post_list post_list_sm">
                <div class="post_img">
                    <a href="<?php echo base_url($request->uri->setSilent()->getSegment(1).'/'.esc($cat_slug->slug)."/$slug"); ?>"><img src="<?php echo IMAGEPATH.$news_article_image; ?>" alt="<?php echo strip_tags($news_headline); ?>"></a>
                </div>
                <div class="post_body">
...
<?php if (@$ad_position == 1) { ?>
    <div class="widget">
        <div class="widget_banner">
            <?php if ($ad_script=="") { ?>
                <a target="_blank" href="<?php echo $ad_link ?> "><img src="<?php echo IMAGEPATH.$ad_image ?>" class="img-fluid" alt="<?php echo strip_tags(esc($ad_name)) ?>"></a>
...
?>
    ...
    <?php if (@$ad_position == 2) { ?>
        <div class="widget">
            <div class="widget_banner">
                <?php if ($ad_script=="") { ?>
                    <a target="_blank" href="<?php echo htmlspecialchars_decode($ad_link) ?> "><img src="<?php echo IMAGEPATH.$ad_image ?>" class="img-responsive center-block" alt="<?php echo strip_tags(esc($ad_name)) ?>"></a>
                <?php } else { echo htmlspecialchars_decode($ad_script); } ?>
            </div>
        </div><!-- /.End of banner -->
    <?php } } ?>
