                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-right">
                                <div class="actions">
                                   <a href="<?php echo base_url('backend/module/add_theme')?>" class="btn btn-success"><i class="ti-align-justify"> </i> <?php echo display('theme')?></a> 
                        ...
                        <div class="row" align="center">
                            <div class="col-md-12 col-md-offset-2">
                                ...
                                <div class="form-group">
                                    <a href="<?php echo base_url('backend/module/add_theme'); ?>" class="btn btn-danger" data-dismiss="modal">Cancel</a>
...
<script src="<?php echo base_url().'/app/Modules/Addon/Assets/ajaxs/addons/download_theme.js?v=1' ?>"></script>
