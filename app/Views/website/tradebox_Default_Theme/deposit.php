  ...
  <div class="col-lg-4 offset-lg-4 form-content login mt-4 mb-4">
   ...
   <div class="deposit-info mb-0 form-design">
      ...
      <div class="form-group">
         <label for="deposit_type" class=""><?php echo display('deposit_crypto_dollar') ?> <span class="text-danger">*</span></label>
      ...
      <div class="form-group">
         <label for="payment_method" class=""><?php echo display('deposit_method');?> <span class="text-danger">*</span></label>
         <select class="custom-select basic-single" name="method" required onchange="Fee()" id="payment_method">
