            ...
            <div class="card-body table-responsive">
                <table id="example" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo $sl++; ?></td>
                            <td><img src="<?php echo $value->image?IMAGEPATH.$value->image:BASEPATH.'assets/images/icons/user.png'; ?>" alt="Image" height="30" width="30" ></td>
                            ...
                            <td class="text-center">
                                ...
                                <?php } else { ?> 
                                    ...
                                    <a href="<?php echo base_url("backend/edit-admin/$value->id") ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="hvr-buzz-out far fa-edit"></i></a>
                                    <a href="<?php echo base_url("backend/admin-delete/$value->id") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Delete "><i class="hvr-buzz-out far fa-trash-alt"></i></a>
                                <?php } ?>
                            </td>
                        </tr>
                        <?php } ?> 
