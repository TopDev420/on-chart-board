      ...
      <div class="row">
         <div class="col-lg-8 offset-lg-2">
            <div class="payment-process">
               ...
               <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="<?php echo $deposit_data['stripe']['publishable_key']; ?>" data-description="<?php echo $deposit_data['description'] ?>" data-amount="<?php $total = $deposit->amount+$deposit->fees_amount; echo round($total*100) ?>" data-locale="auto"></script>
               <?php echo form_close();?>
