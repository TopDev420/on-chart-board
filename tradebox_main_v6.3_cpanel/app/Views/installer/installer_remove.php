...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap -->
         <!-- Bootstrap -->
        <link href="<?php echo BASEPATH."/assets/installer/css/bootstrap.min.css" ?>" rel="stylesheet">
        <link href="<?php echo BASEPATH."/assets/installer/css/installer.css" ?>" rel="stylesheet">
    </head>
    <body>
		...
		<script src="<?php echo BASEPATH."assets/installer/js/jquery-3.4.1.min.js" ?>" ></script>
		<script src="<?php echo BASEPATH."assets/installer/js/bootstrap.min.js" ?>" ></script>
