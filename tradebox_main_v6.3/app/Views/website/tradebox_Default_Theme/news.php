           ...
           ?>
                ...
                <?php if (@$ad_position==3) { ?>
                    <div class="widget_banner">
                        <?php if ($ad_script=="") { ?>
                            <a target="_blank" href="<?php echo $ad_link ?> "><img src="<?php echo IMAGEPATH.$ad_image ?>" class="img-fluid" alt="<?php echo strip_tags($ad_name) ?>"></a>
                ...
                ?>
                    ...
                    <div class="post post_list post_list_lg">
                        <div class="post_img">
                            <a href="<?php echo base_url('news/'.$cat_slug->slug."/$slug"); ?>"><img src="<?php echo IMAGEPATH.$news_article_image; ?>" alt="<?php echo strip_tags($news_headline); ?>"></a>
                        </div>
                        <div class="post_body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="avatar-img">
                                    <img src="<?php echo IMAGEPATH.$news_article_image; ?>" class="" alt="">
                                </div>
                                <div class="meta-info">
                                    <span class="date"><?php
