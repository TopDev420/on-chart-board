                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo base_url("backend/setting/update-gateway/$value->id") ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-cog" aria-hidden="true"></i> Setup</a>
                            </td>
                        </tr>
                        <?php } ?>  
                    </tbody>
