        ...
        <div class="row">
            <main class="col-md-8">
                <div class="post_details">
                    ...
                    <figure>
                        <img class="img-fluid aligncenter" src="<?php echo IMAGEPATH.$news_article_image; ?>" alt="<?php echo strip_tags($news_headline); ?>" width='100%'>
                    </figure>
                ...
                foreach ($advertisement as $add_key => $add_value) { 
                    ...
                    <?php if (@$ad_position == 4) { ?>
                        <div class="widget_banner">
                            <?php if ($ad_script=="") { ?>
                                <a target="_blank" href="<?php echo htmlspecialchars_decode($ad_link) ?> "><img src="<?php echo IMAGEPATH.$ad_image ?>" class="img-fluid" alt="<?php echo strip_tags(esc($ad_name)) ?>"></a>
