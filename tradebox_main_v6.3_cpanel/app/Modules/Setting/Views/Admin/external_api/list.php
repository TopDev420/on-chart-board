                ...
                <table class="datatable2 table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url("backend/setting/update-external-api/$value->id") ?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="fa fa-cog" aria-hidden="true"></i> Setup</a>
                            </td>
                        </tr>
                        <?php } ?>  
                    </tbody>
